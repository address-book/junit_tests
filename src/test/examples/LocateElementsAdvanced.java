...
public class LocateElementsAdvanced extends Base {
    ...
    public void locateElementsCSS() {
        ...
        // CSS for Attribute
        driver.findElement(By.cssSelector("[data-test=sign-in]"));

        // CSS for Multiple Attributes
        driver.findElement(By.cssSelector("[data-test=sign-in][class='nav-item nav-link']"));
    }

    @Test
    public void locateElementsCSSTags() {
        // CSS for ID
        driver.findElement(By.cssSelector("a#sign-in"));

        // CSS for Class Name
        driver.findElement(By.cssSelector("a.nav-item"));

        // CSS for Multiple Classes
        driver.findElement(By.cssSelector("a.nav-item.nav-link"));
